...
namespace :locales do
  ...
  task export: :environment do
    ...
    LocalesExportImport::Yaml2Csv.convert(
      ...
      'en_de_fr_it_nl_pl_ru_simpleform_keys.csv'
    )
  ...
  task import: :environment do
    start_time = Time.now
    csv_file_name = 'en_de_fr_it_nl_pl_ru_simpleform_keys.csv'
    LocalesExportImport::Csv2Yaml.convert(csv_file_name, 'config/locales/', 'simple_form_')
    csv_file_name = 'en_de_fr__it_nl_pl_ru_keys.csv'
